...
if __name__ == "__main__":
    ...
    outfile = "./rh_human_features_1000_fc.tsv"                         # Where to store features
    ...
    trimmed_model = tf.keras.Model(inputs=[model.get_layer("comp_in").input, model.get_layer("comp_mask").input],
                                   outputs=model.get_layer("c_fc_2").output)
